...
class Curation {
  ...
  factory Curation.fromFirestore(DocumentSnapshot doc) {
    ...
    return Curation(
      ...
      averageWantToGo: (data['avg_want_to_go'] ?? 0).toDouble(),
      averageRecommend: (data['avg_recommend'] ?? 0).toDouble(),
  ...
  factory Curation.fromMap(Map<String, dynamic> m) => Curation(
        ...
        averageWantToGo: (m['avg_want_to_go'] ?? 0).toDouble(),
        averageRecommend: (m['avg_recommend'] ?? 0).toDouble(),
